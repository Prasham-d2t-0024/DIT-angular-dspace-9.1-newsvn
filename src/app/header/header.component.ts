...
export class HeaderComponent implements OnInit {
  ...
  logoDimendion:any = {width:'140px', height:'55px'};
  ...
  public toggleNavbar(): void {
    ...
    this.logoDimendion.height = this.imageConfig?.imageSizes?.logo?.height;
    this.logoDimendion.width = this.imageConfig?.imageSizes?.logo?.width;
  }
}
