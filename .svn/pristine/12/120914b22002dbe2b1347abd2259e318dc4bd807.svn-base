...
export class LoginPageComponent implements OnDestroy, OnInit {
  ...
  //   const logoSpace = document.querySelector('.repository-logo') as HTMLElement;
  //   logoSpace.style.width = this.imageservice.imageSizes?.loginPage?.width || '125px'
  //   logoSpace.style.height = this.imageservice.imageSizes?.loginPage?.height || '190px'
  // }
